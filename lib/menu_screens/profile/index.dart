                ...
                : ListView(children: [
                          ...
                          child: builderController.pickedFile != null
                              ? Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.file(
                                        File(
                                            builderController.pickedFile!.path),
                                        fit: BoxFit.cover),
                                  ),
                                )
                              : builderController.userData["foto"] != null
                                  ? Container(
                                      margin: const EdgeInsets.only(top: 10),
                                      width: 80,
                                      height: 80,
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                            imageUrl: Constant.PROFILE_IMAGE +
                                                _profile.userData['foto']
                                                    .toString(),
                                            fit: BoxFit.cover),
                                      ),
                                    )
                    ...
                    Obx(
                      () => _profile.updateLoading.value
                          ...
                          : InkWell(
                              onTap: () {
                                _profile.profileUpdate(_email.text, _phone.text,
                                    _emergency.text, _pdam.text, _pln.text);
                              },
                              child: ButtonColor(
                                  text: "UPDATE", warna: Colors.orange)),
                    ),
                    Jarak(tinggi: 50),
                  ]))));
  }
